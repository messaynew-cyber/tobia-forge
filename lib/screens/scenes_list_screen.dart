...
class ScenesListScreen extends StatelessWidget {
          ...
          slivers: [
              ...
              sliver: SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    Text('The story of a phone that builds.', style: ForgeType.body(color: ForgeColors.muted, size: 13)),
                  ],
                ),
              ),
            ),
            SliverPadding(
              ...
              sliver: SliverList.list(
                children: [ for (final s in kScenes) _tile(context, s) ],
              ),
            ),
          ],
        ),
  ...
  Widget _tile(BuildContext context, ForgeScene s) {
    return Padding(
      ...
      child: StaggeredEntrance(
        ...
        delayMs: 90,
        child: ForgeSurface(
          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => SceneScreen(scene: s))),
          glow: s.glow,
          glowStrength: 0.12,
          radius: 26,
